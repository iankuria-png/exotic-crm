...
class WalletSettingsPhaseFourTest extends TestCase
{
    ...
    public function test_settings_integrations_includes_current_wallet_and_payment_link_payloads_for_workspace_rendering(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('billing.registry.schemas.paystack.provider_key', 'paystack')
            ->assertJsonPath('billing.registry.schemas.paystack.fields.0.key', 'public_key')
            ->assertJsonPath('billing.registry.schemas.nowpayments.supported_environments.0', 'production')
            ->assertJsonPath('wallet.provider_schemas.mpesa_stk.label', 'M-Pesa STK')
            ->assertJsonPath('wallet.provider_schemas.mpesa_stk.fields.0.key', 'transport')
            ->assertJsonPath('wallet.provider_schemas.pesapal.fields.1.configured_flag', 'consumer_secret_configured')

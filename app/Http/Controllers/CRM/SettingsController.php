...
class SettingsController extends Controller
{
    ...
    public function storeTemplate(Request $request)
    {
        $validated = $request->validate([
            ...
            'category' => 'required|in:payment,renewal,follow_up,welcome,new_signup,win_back,credential_setup_link,credential_temp_password',
    ...
    public function updateTemplate(Request $request, Template $template)
    {
        ...
        $validated = $request->validate([
            ...
            'category' => 'sometimes|in:payment,renewal,follow_up,welcome,new_signup,win_back,credential_setup_link,credential_temp_password',
        ...
        $users = User::query()
            ...
            ->map(function (User $user) use ($platformMap) {
                ...
                return [
                    ...
                    'market_down_sms_state' => $user->marketDownSmsState(),
    ...
    public function storeUser(Request $request)
    {
        $validated = $request->validate([
            ...
            'notification_prefs.market_down_sms' => 'nullable|array',
            'notification_prefs.market_down_sms.enabled' => 'nullable|boolean',
            'notification_prefs.market_down_sms.market_ids' => 'nullable|array',
            'notification_prefs.market_down_sms.market_ids.*' => 'integer|exists:platforms,id',
            'reason' => 'nullable|string|max:500',
        ]);

    ...
    private function createProvisionedClient(Request $request, array $payload, string $reason): Client
    {
        ...
        TimelineEvent::create([
            ...
            'content' => [
                ...
                'profile_slug' => $provisioningResult['wp_profile_slug'] ?? null,
                'slug_claim' => $provisioningResult['slug_claim'] ?? null,
                'slug_aliases_released' => (int) ($provisioningResult['slug_aliases_released'] ?? 0),
                'sync_status' => $syncStatus,

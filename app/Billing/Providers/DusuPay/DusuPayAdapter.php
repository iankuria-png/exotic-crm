...
namespace App\Billing\Providers\DusuPay;
...
class DusuPayAdapter extends AbstractProviderAdapter
{
    protected function makeDefinition(): ProviderDefinition
    {
        return new ProviderDefinition(
            ...
            meta: [
                ...
                'status' => 'active',
                'docs_url' => 'https://developer.dusupay.com/funds-collection/mobile-money-collection',
            ]
        );
    }
}

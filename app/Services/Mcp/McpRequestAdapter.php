...
class McpRequestAdapter
{
    ...
    {
        $query = [];
        foreach (['window' => 'horizon', 'from' => 'from', 'to' => 'to', 'platform_id' => 'platform_id', 'reporting_currency' => 'reporting_currency', 'bucket' => 'bucket', 'date' => 'date', 'limit' => 'limit'] as $mcpKey => $httpKey) {

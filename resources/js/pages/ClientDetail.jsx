...
export default function ClientDetail() {
    ...
    const mediaUploadHasImage = mediaUploadFiles.some((file) => isImageUploadFile(file));
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-2">
                                ...
                                {Number(client.whatsapp_inbound_count || 0) > 0 ? (
                                    <span className="inline-flex items-center rounded-md bg-emerald-50 px-2.5 py-0.5 text-xs font-medium text-emerald-700 ring-1 ring-inset ring-emerald-200">
                                        WhatsApp inbound {client.whatsapp_inbound_count}
                                    </span>
                                ) : null}
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    const result = startClientMediaUpload({
                                                        ...
                                                        watermarkEnabled: mediaUploadWatermarkEnabled,
                                                        watermarkPosition: mediaUploadWatermarkPosition,
                                                        watermarkSize: mediaUploadWatermarkSize,
                                                    });
                                                    if (result?.queued) {
                                                        setMediaUploadFiles([]);
                                                        setMediaUploadSetMain(false);

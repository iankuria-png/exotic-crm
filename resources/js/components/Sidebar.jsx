...
const navItems = [
    ...
    { to: '/deals', label: 'Subscriptions', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    { to: '/campaigns', label: 'Campaigns', icon: 'M4 4v5h.582m14.756 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-14.756-2m14.756 2H15' },
    ...
    return (
        <div className="flex h-full flex-col bg-slate-950 text-slate-100">
            ...
            <div className="flex h-14 items-center justify-between border-b border-slate-800/80 px-4">
                ...
                <button
                    onClick={onClose}
                    className="rounded-md p-1 text-slate-500 transition-colors hover:bg-slate-900 hover:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 lg:hidden"
            ...
            <nav className="flex-1 space-y-1.5 px-2.5 py-5">
                {navItems.map((item) => (
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex items-center gap-3 rounded-lg px-3.5 py-2.5 text-[1.02rem] font-medium transition-colors ${
                                isActive
                                    ? 'bg-slate-900 text-slate-100 ring-1 ring-slate-700 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)]'
                                    : 'text-slate-300 hover:bg-slate-900/75 hover:text-slate-100'
                            }`
                        }
                        onClick={onClose}
                    >

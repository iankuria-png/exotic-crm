...
const navGroups = [
    {
        ...
        items: [
            ...
            { to: '/stories', label: 'Stories', icon: 'M12 3a9 9 0 0 1 6.36 2.64M21 12a9 9 0 0 1-2.64 6.36M12 21a9 9 0 0 1-6.36-2.64M3 12a9 9 0 0 1 2.64-6.36M12 8.25v7.5M8.25 12h7.5' },
    ...
    },
    {
        ...
        items: [
            ...
            { to: '/lifecycle', label: 'Lifecycle', icon: 'M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm9.75-5.25v5.25l3.375 2.03' },
...
function insertVisitorsGroup(groups) {
    const output = [];

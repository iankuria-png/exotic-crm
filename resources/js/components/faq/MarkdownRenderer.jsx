        ...
        <div className="max-w-none text-[15px] leading-7 text-slate-700">
            <ReactMarkdown
                components={{
                    ...
                    img: ({ ...props }) => <img {...props} className="my-6 rounded-2xl border border-slate-200 shadow-sm" alt={props.alt || ''} />,
                    video: ({ ...props }) => <video {...props} controls className="my-6 w-full rounded-2xl border border-slate-200 shadow-sm" />,

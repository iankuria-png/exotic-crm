...
const statusStyles = {
    ...
    archived: 'bg-orange-50 text-orange-800 ring-orange-300',
    removed: 'bg-slate-200 text-slate-600 ring-slate-300',
    draft: 'bg-amber-50 text-amber-700 ring-amber-200',
    pending: 'bg-amber-50 text-amber-700 ring-amber-200',
    queued: 'bg-sky-50 text-sky-700 ring-sky-200',
    running: 'bg-teal-50 text-teal-700 ring-teal-200',
    provisioning: 'bg-teal-50 text-teal-700 ring-teal-200',
    partial: 'bg-amber-50 text-amber-700 ring-amber-200',
    media_pending: 'bg-amber-50 text-amber-700 ring-amber-200',
    skipped_duplicate: 'bg-slate-100 text-slate-600 ring-slate-200',
    reverted: 'bg-orange-50 text-orange-800 ring-orange-300',
    // Deal statuses

...
const REASON_META = {
    ...
    // WebPushr provider errors
    webpushr_credentials_missing: ['missing credentials', 'critical'],
    webpushr_unauthorized: ['auth failure', 'critical'],
    webpushr_forbidden: ['forbidden', 'critical'],
    webpushr_not_found: ['not found', 'critical'],
    webpushr_validation: ['validation error', 'warn'],
    webpushr_rate_limited: ['rate limited', 'warn'],
    webpushr_provider_error: ['WebPushr 5xx', 'critical'],
    webpushr_http_error: ['WebPushr HTTP', 'warn'],
    webpushr_rejected: ['provider rejected', 'warn'],
    // WonderPush provider errors
    wonderpush_credentials_missing: ['missing credentials', 'critical'],
    wonderpush_unauthorized: ['auth failure', 'critical'],
    wonderpush_forbidden: ['forbidden', 'critical'],
    wonderpush_not_found: ['not found', 'critical'],
    wonderpush_validation: ['validation error', 'warn'],
    wonderpush_rate_limited: ['rate limited', 'warn'],
    wonderpush_provider_error: ['WonderPush 5xx', 'critical'],
    wonderpush_http_error: ['WonderPush HTTP', 'warn'],
    wonderpush_rejected: ['provider rejected', 'warn'],
    // iZooto provider errors
    izooto_credentials_missing: ['missing credentials', 'critical'],
    izooto_unauthorized: ['auth failure', 'critical'],
    izooto_forbidden: ['forbidden', 'critical'],
    izooto_not_found: ['not found', 'critical'],
    izooto_validation: ['validation error', 'warn'],
    izooto_rate_limited: ['rate limited', 'warn'],
    izooto_provider_error: ['iZooto 5xx', 'critical'],
    izooto_http_error: ['iZooto HTTP', 'warn'],
    izooto_rejected: ['provider rejected', 'warn'],
    // Job-side fallbacks

...
export default function CeoHeader({
    ...
    return (
        <header className="sticky top-0 z-20 -mx-1 rounded-lg border border-slate-200 bg-white/95 px-4 py-3 shadow-sm backdrop-blur">
            ...
            <div className="mt-3 grid gap-3 xl:grid-cols-[auto_minmax(220px,1fr)_auto]">
